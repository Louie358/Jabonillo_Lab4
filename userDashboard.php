                    ...
                    <table>
                        ...
                        <?php while ($row = $students->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <img src="<?php echo htmlspecialchars('img/' . (!empty($row['profile_pic']) ? $row['profile_pic'] : 'default.jpg')); ?>" alt="Profile Picture" class="profile-pic" style="width: 50px; height: 50px; border-radius: 50%;">
                                </td>
